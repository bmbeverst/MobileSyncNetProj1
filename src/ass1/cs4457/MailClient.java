...
public class MailClient extends Frame {
	...
	private TextField serverField = new TextField("128.143.2.232", 40);
	private Label fromLabel = new Label("From:");
	private TextField fromField = new TextField("bmb2gf@virgina.edu", 40);
	private Label toLabel = new Label("To:");
	private TextField toField = new TextField("bmb2gf@virgina.edu", 40);
	private Label subjectLabel = new Label("Subject:");
	private TextField subjectField = new TextField("Testing!", 40);
	private Label messageLabel = new Label("Message:");
	private TextArea messageText = new TextArea("This is a test message. I hate typing this in over and over again!", 10, 40);
